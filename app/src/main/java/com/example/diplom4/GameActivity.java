...
public class GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSoundPairs.add(new ImageSoundPair(R.drawable.dad, R.raw.father));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.mam, R.raw.mother));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.bro, R.raw.brother));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.sis, R.raw.sister));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.litlesis, R.raw.litlesis));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.litlebro, R.raw.litlebro));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.grandfat, R.raw.grandfather));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.grandmom, R.raw.grandmother));
