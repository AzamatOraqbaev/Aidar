...
public class GameSandarActiivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSoundPairs.add(new ImageSoundPair(R.drawable.pineapple, R.raw.pineapple));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.pomegranat, R.raw.pomegrand));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.raspberries, R.raw.raspberries));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.strawberry, R.raw.strawberry));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.watermelon, R.raw.watermelon));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.apple, R.raw.apple));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.apricot, R.raw.apricot));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.avocado, R.raw.avacado));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.banan, R.raw.banan));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.cherry, R.raw.cherry));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.grape, R.raw.grape));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.kiwi, R.raw.kiwi));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.lemon, R.raw.lemon));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.melon, R.raw.melon));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.orange, R.raw.orange));
        imageSoundPairs.add(new ImageSoundPair(R.drawable.pear, R.raw.pear));
